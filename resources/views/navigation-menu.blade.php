<nav class="bg-gray-800" x-data="{ data:false }" >
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
          ...
          <button x-on:click="data = true"  type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="data" x-on:click.away = "data=false" >
...
{{--        
        @foreach ($categories as $category)
          <a href="{{ route('posts.category',$category) }} class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{ $category }}</a>
        @endforeach --}}
